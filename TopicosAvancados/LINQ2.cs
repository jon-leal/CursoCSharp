...
using System.Linq;
using static CursoCSharp.TopicosAvancados.LINQ1;
    ...
    class LINQ2
    {
        public static void Executar()
        {
            ...
            var fulano = alunos.SingleOrDefault( 
                aluno => aluno.Nome.Equals("Fulano")); // Usar SingleOrDefault para não dar erro quando não encontrar o nome do aluno
            if (fulano == null)
            {
